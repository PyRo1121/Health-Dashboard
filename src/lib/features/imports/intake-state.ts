...
function inferSourceType(current: ImportSourceType, summary: ImportPayloadSummary | null): ImportSourceType {
...
export function canPreviewImportPayload(state: Pick<
	ImportIntakeState,
	'payload' | 'isManualAnalysisPending' | 'payloadSummary'
>): boolean {
	return (
...
export function queuedImportFile(
