...
import type { HealthEvent, NativeCompanionBundle, NativeCompanionRecord } from '$lib/core/domain/types';
...
function isSupportedMetric(metricType: string): boolean {
	return HEALTHKIT_SUPPORTED_METRICS.includes(metricType as (typeof HEALTHKIT_SUPPORTED_METRICS)[number]);
}
