...
export async function saveJournalEntry(db: HealthDatabase, draft: JournalDraft): Promise<JournalEntry> {
...
export async function listJournalEntriesForDay(db: HealthDatabase, localDay: string): Promise<JournalEntry[]> {
