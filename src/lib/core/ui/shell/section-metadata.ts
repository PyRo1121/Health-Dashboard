...
export const APP_SECTIONS: AppSectionMeta[] = [
  {
    ...
    pageDescription:
      'The local-first shell is ready. Start with Today, Journal, and Review as the primary user loop.',
  ...
  },
  {
    ...
    pageDescription:
      'Quick mood, energy, stress, sleep, sobriety, and same-day context will live here.',
  ...
  },
  {
    ...
    pageDescription:
      'Shape the week, turn recipes into groceries, and hand planned meals or workouts into Today.',
    showInDesktopNav: true,
    showInMobileNav: true,
  },
  {
    ...
    href: '/movement',
    title: 'Movement',
    navDescription: 'Exercise search and workout template building.',
    pageEyebrow: 'Movement Loop',
    pageDescription:
      'Build workout templates, search exercises, and keep the movement loop ready for the planner.',
    showInDesktopNav: true,
    showInMobileNav: false,
  },
  {
    ...
    href: '/groceries',
    title: 'Groceries',
    navDescription: 'Weekly grocery checklist derived from the current plan.',
    pageEyebrow: 'Weekly Ledger',
    pageDescription:
      'Check off ingredients, refine pantry state, and keep recipe-linked grocery rows grounded in the current plan.',
    showInDesktopNav: true,
    showInMobileNav: false,
  },
  {
  ...
  },
  {
    ...
    pageDescription:
      'Track sleep context, symptoms, anxiety episodes, and medication or supplement use in one local loop.',
    showInDesktopNav: true,
    showInMobileNav: false,
  },
  {
  ...
  },
  {
    ...
    pageDescription:
      'Sobriety status, cravings, lapse context, and recovery actions will live here.',
    showInDesktopNav: true,
    showInMobileNav: false,
  },
  {
  ...
  },
  {
    ...
    pageEyebrow: 'History',
    pageDescription:
      'Cross-domain event history and source provenance. This is the proof surface for native companion imports.',
    showInDesktopNav: true,
    showInMobileNav: false,
  },
  {
  ...
  },
  {
    ...
    pageDescription:
      'Preview Shortcut JSON, SMART sandbox FHIR Bundles, native iPhone bundles, Apple Health XML, and Day One JSON before anything lands.',
    showInDesktopNav: true,
    showInMobileNav: false,
  },
  {
    ...
    pageDescription:
      'Use this page to download the no-Mac iPhone kit, confirm connection status, and jump into the import center.',
    showInDesktopNav: true,
    showInMobileNav: false,
  },
  {
