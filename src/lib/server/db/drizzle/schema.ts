...
export const recipeCatalogItems = sqliteTable(
  'recipeCatalogItems',
  {
    id: text('id').primaryKey(),
    title: text('title'),
...
export const derivedGroceryItems = sqliteTable(
  'derivedGroceryItems',
  {
    id: text('id').primaryKey(),
    weeklyPlanId: text('weeklyPlanId'),
...
export const manualGroceryItems = sqliteTable(
  'manualGroceryItems',
  {
    id: text('id').primaryKey(),
    weeklyPlanId: text('weeklyPlanId'),
...
export const exerciseCatalogItems = sqliteTable(
...
export const favoriteMeals = sqliteTable(
  'favoriteMeals',
  {
    id: text('id').primaryKey(),
    mealType: text('mealType'),
...
export const healthTemplates = sqliteTable(
  'healthTemplates',
  {
    id: text('id').primaryKey(),
...
export const sobrietyEvents = sqliteTable(
  'sobrietyEvents',
  {
    id: text('id').primaryKey(),
    localDay: text('localDay'),
...
export const adherenceMatches = sqliteTable(
  'adherenceMatches',
  {
    id: text('id').primaryKey(),
    weekStart: text('weekStart'),
